...
```zsh
/bin/zsh -lc 'git clone https://github.com/danielppolo/agent-dotfiles.git /Users/Shared/hermes-dotfiles 2>/dev/null || git -C /Users/Shared/hermes-dotfiles pull; /Users/Shared/hermes-dotfiles/setup'
```
